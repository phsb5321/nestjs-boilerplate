...
import { {{pascalCase name}}GetService } from '@/modules/{{kebabCase name}}/services/{{kebabCase name}}-get/{{kebabCase name}}-get.service';
...
export class {{pascalCase name}}GetController {
  constructor(private readonly {{camelCase name}}GetService: {{pascalCase name}}GetService) {}
  ...
  findAll(@Query() getPaginated{{pascalCase name}}Dto: GetPaginated{{pascalCase name}}Dto) {
