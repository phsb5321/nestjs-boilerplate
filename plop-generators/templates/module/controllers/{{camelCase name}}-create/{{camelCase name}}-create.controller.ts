...
export class {{pascalCase name}}CreateController {
  constructor(private readonly {{camelCase name}}{{pascalCase name}}CreateService: {{pascalCase name}}CreateService) {}
  ...
  create(@Body() create{{pascalCase name}}Dto: Create{{pascalCase name}}Dto) {
    return this.{{camelCase name}}{{pascalCase name}}CreateService.create(create{{pascalCase name}}Dto);
  }
}
